...
public static void testNoiseReduction() throws IOException {
    ...
    new ImageNoiseFilter()
        ...
        if (comparator.compare("tests/data/java-logo.txt","tests/data/java-logo.noisy.25.clean.txt")) {
        if (comparator.compare("tests/data/java-logo.txt","tests/data/java-logo.noisy.50.clean.txt")) {
        if (comparator.compare("tests/data/java-logo.txt", "tests/data/java-logo.noisy.75.clean.txt")) {
        if (comparator.compare("tests/data/eclipse-logo.txt","tests/data/eclipse-logo.noisy.25.clean.txt")) {
        if (comparator.compare("tests/data/eclipse-logo.txt","tests/data/eclipse-logo.noisy.50.clean.txt")) {
        if(comparator.compare("tests/data/eclipse-logo.txt","tests/data/eclipse-logo.noisy.75.clean.txt"));
